      ...
      <section class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#ff355c] via-[#ff5b46] to-[#ff8c30] px-6 py-7 shadow-lg">
        ...
        <div class="relative flex items-center gap-5">
          <div class="flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-2xl bg-white/15 ring-1 ring-white/25 backdrop-blur-sm">
            <svg viewBox="0 0 120 120" class="h-13 w-13" xmlns="http://www.w3.org/2000/svg">
              <rect x="18" y="20" width="84" height="78" rx="18" fill="#FF7A6E" />
              <rect x="18" y="20" width="84" height="28" rx="18" fill="#FFB0A4" />
              <path d="M20 39C42 54 78 54 100 39" stroke="#FFCC63" stroke-width="4" stroke-linecap="round" />
              <circle cx="60" cy="62" r="18" fill="#FFE48D" stroke="#FFB22B" stroke-width="3" />
              <path d="M52 58H68" stroke="#FF8F20" stroke-width="3.5" stroke-linecap="round" />
              <path d="M60 50V74" stroke="#FF8F20" stroke-width="3.5" stroke-linecap="round" />
            </svg>
          </div>
