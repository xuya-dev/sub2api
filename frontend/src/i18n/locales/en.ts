export default {
  ...
  checkin: {
    ...
    luckRewardTitle: 'Lucky Check-in Reward · Multiplier ${multiplier}x',
    ...
    blindboxTitle: 'You got a blind box reward!',
    blindboxRarity: 'Rarity',
    blindboxReward: 'Reward',
    blindboxCommon: 'Common',
    blindboxRare: 'Rare',
    blindboxEpic: 'Epic',
    blindboxLegendary: 'Legendary',
    ...
    blindboxDays: 'd',
    page: {
      description: 'Daily check-in rewards, blind box prizes & account overview',
      balance: 'Balance',
      streak: 'Streak',
      days: ' days',
      concurrency: 'Concurrency',
      blindboxCount: 'Blind Box',
      noBlindbox: 'No blind box prizes yet. Keep checking in!',
      todayResult: "Today's Check-in",
      todayResultDesc: 'Your check-in result for today',
      todayNormal: 'Normal Check-in',
      todayLuck: 'Lucky Check-in',
      todayReward: 'Reward',
      todayMultiplier: 'Multiplier',
      todayBlindbox: 'Blind Box',
      todayBlindboxPrize: 'Prize',
      todayNoResult: 'Not checked in yet',
      rewardStats: 'Reward Summary',
      statBalance: 'Balance Earned',
      statConcurrency: 'Concurrency Earned',
      statSubscription: 'Subscriptions',
      statInvitation: 'Invitation Codes',
      noStats: 'No rewards yet',
      rarityBreakdown: 'Rarity Breakdown',
      blindboxInfo: 'Blind Box Info',
      triggerType: 'Trigger Type',
      triggerTotal: 'Total Check-ins',
      triggerStreak: 'Streak Days',
  ...
  redpacket: {
    title: 'Red Packet Center',
    subtitle: 'Send, claim, and share the joy',
    create: 'Send Packet',
    createDesc: 'Send a balance red packet to friends',
    claim: 'Claim Packet',
    claimDesc: 'Enter code to claim a red packet',
    createPanelHint: 'Fill in the amount, count and memo. A shareable code will be generated.',
    claimPanelHint: "Enter your friend's code. The amount will be credited to your balance.",
    ...
    random: 'Lucky Draw',
    memo: 'Memo',
    memoPlaceholder: 'Good luck and prosperity!',
    code: 'Red Packet Code',
    codePlaceholder: 'Enter red packet code',
    created: 'Red Packet Created!',
    createdSuccess: 'Red packet created successfully',
    shareCode: 'Share this code with your friends to claim',
    congrats: 'Congratulations! You got',
    myPackets: 'My Red Packets',
    remainingAmount: 'Remaining',
    remaining: 'Remaining',
    copies: '',
    claimDetail: 'Claim Details',
    noClaimsYet: 'No claims yet',
    noPackets: 'No red packets yet',
    waitingClaim: '{n} left to claim',
    statusActive: 'Active',
    statusExhausted: 'Claimed',
  ...
  admin: {
    ...
    modelPricing: {
      ...
      cacheWriteCost: 'Cache Write ($/MTok)',
      cacheReadCost: 'Cache Read ($/MTok)',
      source: 'Source',
      locked: 'Locked',
      lockedHint: 'Locked entries are skipped during remote sync',
      actions: 'Actions',
      remote: 'Remote',
      manual: 'Manual',
      autoSync: 'Auto Sync',
      ...
      cacheWriteCostPerToken: 'Cache Write Cost (per token)',
      cacheReadCostPerToken: 'Cache Read Cost (per token)',
    ...
    settings: {
      ...
      checkin: {
        ...
        blindboxTitle: 'Check-in Blind Box',
        blindboxDescription: 'Trigger a blind box draw after N consecutive/total check-ins',
        blindboxTriggerType: 'Trigger Type',
        blindboxTriggerStreak: 'Consecutive Streak',
    ...
    blindbox: {
      ...
      colStatus: 'Status',
      colActions: 'Actions',
      namePlaceholder: 'e.g. Lucky Balance Pack',
      rewardBalance: 'Balance',
      rewardConcurrency: 'Concurrency',
      rewardSubscription: 'Subscription Trial',
      rewardInvitation: 'Invitation Code',
      minValue: 'Min Value',
      maxValue: 'Max Value',
      concurrencyValue: 'Concurrency Increase',
      subscriptionGroup: 'Subscription Group',
      selectGroup: 'Select a group',
      subscriptionDays: 'Trial Days',
      days: ' days',
      weightHint: 'Higher value = higher probability',
      totalItems: 'Total Items',
      enabledItems: 'Enabled',
      totalDraws: 'Total Draws',
      confirmDelete: 'Are you sure you want to delete this prize?'
    },
