export default {
  ...
  checkin: {
    ...
    luckRewardTitle: '运气签到奖励 · 倍率 ${multiplier}x',
    betAmount: '下注金额',
    ...
    blindboxTitle: '恭喜获得盲盒奖励！',
    blindboxRarity: '品质',
    blindboxReward: '奖励',
    blindboxCommon: '普通',
    blindboxRare: '稀有',
    blindboxEpic: '史诗',
    blindboxLegendary: '传说',
    ...
    blindboxDays: '天',
    page: {
      description: '每日签到奖励、盲盒奖品和账户概览',
      balance: '余额',
      streak: '连续签到',
      days: '天',
      concurrency: '并发',
      blindboxCount: '盲盒',
      noBlindbox: '还没有盲盒奖品，坚持签到吧！',
      todayResult: '今日签到',
      todayResultDesc: '今天的签到结果',
      todayNormal: '普通签到',
      todayLuck: '幸运签到',
      todayReward: '奖励',
      todayMultiplier: '倍率',
      todayBlindbox: '盲盒',
      todayBlindboxPrize: '奖品',
      todayNoResult: '今日尚未签到',
      rewardStats: '奖励统计',
      statBalance: '获得余额',
      statConcurrency: '获得并发',
      statSubscription: '订阅卡',
      statInvitation: '邀请码',
      noStats: '暂无奖励',
      rarityBreakdown: '稀有度分布',
      blindboxInfo: '盲盒规则',
      triggerType: '触发方式',
      triggerTotal: '累计签到',
      triggerStreak: '连续签到',
  ...
  redpacket: {
    title: '红包中心',
    subtitle: '发红包，领红包，分享快乐',
    create: '发红包',
    createDesc: '发送余额红包给好友',
    claim: '领红包',
    claimDesc: '输入口令领取红包',
    createPanelHint: '填写金额、份数和附言，系统会生成可分享口令',
    claimPanelHint: '输入好友分享的口令，系统会自动入账到你的余额',
    totalAmount: '总金额',
    count: '份数',
    type: '类型',
    equal: '等分红包',
    random: '拼手气红包',
    memo: '附言',
    memoPlaceholder: '恭喜发财，大吉大利！',
    code: '红包口令',
    codePlaceholder: '输入红包口令',
    created: '红包已创建！',
    createdSuccess: '红包创建成功',
    shareCode: '将此口令分享给好友即可领取',
    congrats: '恭喜！获得',
    myPackets: '我的红包',
    remainingAmount: '剩余',
    remaining: '剩余',
  ...
  admin: {
    ...
    modelPricing: {
      ...
      cacheWriteCost: '缓存写入 ($/百万Token)',
      cacheReadCost: '缓存读取 ($/百万Token)',
      source: '来源',
      locked: '锁定',
      lockedHint: '锁定的条目在远程同步时会被跳过',
      actions: '操作',
      remote: '远程',
      manual: '手动',
      autoSync: '自动同步',
      ...
      cancel: '取消',
      bulkDelete: '批量删除',
      inputCostPerToken: '输入价格 (每Token)',
      outputCostPerToken: '输出价格 (每Token)',
      cacheWriteCostPerToken: '缓存写入价格 (每Token)',
      cacheReadCostPerToken: '缓存读取价格 (每Token)',
    ...
    settings: {
      ...
      checkin: {
        ...
        blindboxTitle: '签到盲盒',
        blindboxDescription: '签到满指定天数/次数后触发盲盒抽奖',
        blindboxTriggerType: '触发方式',
        blindboxTriggerStreak: '连续签到',
    ...
    blindbox: {
      ...
      colStatus: '状态',
      colActions: '操作',
      namePlaceholder: '例如：幸运余额包',
      rewardBalance: '余额',
      rewardConcurrency: '并发',
      rewardSubscription: '订阅体验卡',
      rewardInvitation: '邀请码',
      minValue: '最小值',
      maxValue: '最大值',
      concurrencyValue: '并发增加值',
      subscriptionGroup: '订阅分组',
      selectGroup: '请选择分组',
      subscriptionDays: '体验天数',
      days: '天',
      weightHint: '数值越大，抽中概率越高',
      totalItems: '奖品总数',
      enabledItems: '已启用',
      totalDraws: '累计抽取',
      confirmDelete: '确定删除该奖品吗？'
    },
